...
<div className="form-group row my-1">
  ...
  <div className="col-sm-10">
        <input type="text" className="form-control" id="type" placeholder="Enter type of item like bread/chicken/rice/..." value={type} onChange={e=>setType(e.target.value.toLowerCase().trim())} required/>
      </div>
</div>
